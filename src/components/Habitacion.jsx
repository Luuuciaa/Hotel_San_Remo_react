  ...
  return (
    <article className=" flex flex-col items-center justify-center 
      ...
      <div className='flex justify-start mt-4 gap-x-3'>
        ...
        <Link
          to={`/habitaciones/${id}`}
          className="cursor-pointer w-full sm:w-auto  inline-flex justify-center text-center  items-center px-3 py-2 text-sm   sm:px-4 sm:py-2 sm:text-base lg:py-2 lg:text-2x
                     bg-[#d8b25e] text-[#3f2c0e] font-bold  rounded-full 
                     hover:bg-[#3f2c0e] hover:text-[#fcf8ef] transition-colors duration-300  font-[Montserrat] "
        >
          Ver detalle
        </Link>
      </div>
